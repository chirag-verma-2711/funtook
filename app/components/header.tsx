...
export default function Header() {
  ...
  return (
    <header className="">
      <div className="text-center sm:text-lg text-sm font-semibold p-2 text-white bg-[var(--pinkd)]">
      ...
      <div className="container mx-auto px-4 lg:py-4 flex">
        ...
        <div className="flex justify-between items-center w-full *:lg:w-[33.3%]">
            ...
            <form className="flex items-center mx-auto rounded-md overflow-hidden">
              ...
              <div className="relative w-full">
                <input
                  type="text"
                  id="simple-search"
                  className="px-3 py-2.5 bg-[var(--pinkl)] rounded-base outline-none text-heading text-sm block w-full placeholder:text-[#7B7A7A]"
              ...
              <button
                type="submit"
                className="inline-flex items-center justify-center shrink-0 text-white bg-[var(--pinkd)] hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs rounded-base w-10 h-10 focus:outline-none"
              >
                <svg
                  className="w-5 h-5"
                  aria-hidden="true"
          ...
          <div className="flex gap-5 items-center justify-end">
            <Link href="#" className="lg:block hidden">
              <div className="flex gap-1 items-center">
                <Image
                  ...
                  className="w-full h-auto max-w-[24px]"
                  alt="call"
                  width={100}
                  height={100}
                />
            ...
            <button className="">
              <div className="md:block hidden bg-[var(--pinkd)] text-white py-2 px-5 rounded-md">
                Sign Up
              </div>
      ...
      <nav className="">
        <div className="border-t border-b border-gray-300 py-3 lg:block hidden">
          {/* Desktop Menu */}
          <div className="hidden sm:flex sm:items-center sm:justify-center space-x-4 *:px-3 *:py-1 *:text-black *:hover:text-[var(--pinkd)] *:transition-all *:ease-in-out">
